...
# ********   REFACTOR JESUS GOMEZ: CLASE YOLO *********
...
class InferenciaYolo:
    def __init__(self, ruta, input='Foto'):
        self.__ruta = ruta
        self.__input = input
        self.__red, self.__clases, self.colores, self.__capas_salida = self.carga_modelo(ruta)

    def carga_modelo(self):
        pass

    def inferencia(self, mostrar='SI', grabar='NO'):
        pass

    def inferencia_continua(self):
        pass
